! function (t) {
     ...
     */
    var o, s, a, u, c, l, f, h, d, p, g, m, v, y, b, _, w, x, k, T, C, S, E, q, P, A, O, L, D = {
            autoSleep: 120,
            force3D: "auto",
            nullTargetWarn: 1,
            units: {
        ...
        de = function (t) {
            for (var e, n, r, i, o = 0, s = ""; ~(e = t.indexOf("random(", o));) r = t.indexOf(")", e), i = "[" === t.charAt(e + 7), n = t.substr(e + 7, r - e - 7).match(i ? rt : J), s += t.substr(o, e - o) + fe(i ? n : +n[0], i ? 0 : +n[1], +n[2] || 1e-5), o = r + 1;
        ...
        we = function (t, e, n) {
            ...
            if (!d) {
                if ("," === t.substr(-1) && (t = t.substr(0, t.length - 1)), be[t]) d = be[t];
                    ...
                    } else s = +d[0] % 360 / 360, a = +d[1] / 100, r = 2 * (u = +d[2] / 100) - (i = u <= .5 ? u * (a + 1) : u + a - u * a), d.length > 3 && (d[3] *= 1), d[0] = _e(s + 1 / 3, r, i), d[1] = _e(s, r, i), d[2] = _e(s - 1 / 3, r, i);
        ...
        Oe = /["']/g,
        Le = function (t) {
            for (var e, n, r, i = {}, o = t.substr(1, t.length - 3).split(":"), s = o[0], a = 1, u = o.length; a < u; a++) n = o[a], e = a !== u - 1 ? n.lastIndexOf(",") : n.length, r = n.substr(0, e), i[s] = isNaN(r) ? r.replace(Oe, "").trim() : +r, s = n.substr(e + 1).trim();
            return i
        },
        De = function (t) {
            return function (e) {
    ...
    })), Pe.Linear.easeNone = Pe.none = Pe.Linear.easeIn, Ne("Elastic", Ie("in"), Ie("out"), Ie()), P = 7.5625, O = 1 / (A = 2.75), Ne("Bounce", (function (t) {
        return 1 - L(1 - t)
    }), L = function (t) {
    ...
    })), Ne("Back", Be("in"), Be("out"), Be()), Pe.SteppedEase = Pe.steps = ot.SteppedEase = {
        config: function (t, e) {
            void 0 === t && (t = 1);
            var n = 1 / t,
                r = t + (e ? 0 : 1),
    ...
    }, j.ease = Pe["quad.out"], kt("onComplete,onUpdate,onStart,onRepeat,onReverseComplete,onInterrupt", (function (t) {
        ...
        Fe = function () {
            ...
            return e.delay = function (t) {
                ...
                if (n && n.smoothChildTiming && this._ts) {
                    for (Ut(this, t), !n._dp || n.parent || $t(n, this); n.parent;) n.parent._time !== n._start + (n._ts >= 0 ? n._tTime / n._ts : (n.totalDuration() - n._tTime) / -n._ts) && n.totalTime(n._tTime, !0), n = n.parent;
    ...
    var ze = function (t) {
        ...
        return n.to = function (t, e, n) {
            ...
            for (var n, r = [], i = se(t), o = this._first, s = X(e); o;) o instanceof Ke ? Ct(o._targets, i) && (s ? (!We || o._initted && o._ts) && o.globalTime(0) <= e && o.globalTime(o.totalDuration()) > e : !e || o.isActive()) && r.push(o) : (n = o.getTweensOf(i, e)).length && r.push.apply(r, n), o = o._next;
            return r
    ...
    var We, Xe = function (t, e, n, r, i, o, s) {
            var a, u, c, l, f, h, d, p, g = new hn(this._pt, t, e, 0, 1, sn, null, i),
                m = 0,
                v = 0;
            for (g.b = n, g.e = r, n += "", (d = ~(r += "").indexOf("random(")) && (r = de(r)), o && (o(p = [n, r], t, e), n = p[0], r = p[1]), u = n.match(et) || []; a = et.exec(r);) l = a[0], f = r.substring(m, a.index), c ? c = (c + 1) % 5 : "rgba(" === f.substr(-5) && (c = 1), l !== u[v++] && (h = parseFloat(u[v - 1]) || 0, g._pt = {
                _next: g._pt,
                p: f || 1 === v ? f : ",",
                s: h,
            ...
            function e(e, n, i, a) {
                ...
                if (u._targets = q.length ? _t(q) : ct("GSAP target " + e + " not found. https://greensock.com", !D.nullTargetWarn) || [], u._ptLookup = [], u._overwrite = x, k || w || Q(y) || Q(b)) {
                    if (n = u.vars, (c = u.timeline = new ze({
                            data: "nested",
                            defaults: T || {}
                        })).kill(), c.parent = c._dp = r(u), c._start = 0, k) Ot(c.vars.defaults, {
                        ease: "none"
    ...
    kt(bt + "parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger", (function (t) {
        return ht[t] = 1
    })), ot.TweenMax = ot.TweenLite = Ke, ot.TimelineLite = ot.TimelineMax = ze, s = new ze({
        sortChildren: !1,
        defaults: j,
    ...
    var dn = {
        ...
        exportRoot: function (t, e) {
            void 0 === t && (t = {});
            var n, r, i = new ze(t);
            for (i.smoothChildTiming = Y(t.smoothChildTiming), s.remove(i), i._dp = 0, i._time = i._tTime = s._time, n = s._first; n;) r = n._next, !e && !n._dur && n instanceof Ke && n.vars.onComplete === n._targets[0] || Yt(i, n, n._start - n._delay), n = r;
            return Yt(s, i, 0), i
        },
        utils: {
    ...
    var vn, yn, bn, _n, wn, xn, kn, Tn, Cn = {},
        ...
        ar = function (t, e, n, r) {
            ...
            if (y.b = n, y.e = r, n += "", "auto" === (r += "") && (t.style[e] = r, r = Vn(t, e) || r, t.style[e] = n), Se(s = [n, r]), r = s[1], u = (n = s[0]).match(tt) || [], (r.match(tt) || []).length) {
                for (; a = tt.exec(r);) h = a[0], p = r.substring(b, a.index), l ? l = (l + 1) % 5 : "rgba(" !== p.substr(-5) && "hsla(" !== p.substr(-5) || (l = 1), h !== (f = u[_++] || "") && (c = parseFloat(f) || 0, m = f.substr((c + "").length), (v = "=" === h.charAt(1) ? +(h.charAt(0) + "1") : 0) && (h = h.substr(2)), d = parseFloat(h), g = h.substr((d + "").length), b = tt.lastIndex - g.length, g || (g = g || D.units[e] || m, b === r.length && (r += g, y.e += g)), m !== g && (c = or(t, e, f, g) || 0), y._pt = {
                    _next: y._pt,
                    p: p || 1 === _ ? p : ",",
                    s: c,
                    c: v ? v * d : d - c,
                ...
                if (S && f in S ? (o = "function" == typeof S[f] ? S[f].call(n, r, t, i) : S[f], f in D.units && !ne(o) && (o += D.units[f]), "=" === (o + "").charAt(1) && (o = sr(t, f))) : o = sr(t, f), u = parseFloat(o), (p = "string" === c && "=" === s.charAt(1) ? +(s.charAt(0) + "1") : 0) && (s = s.substr(2)), a = parseFloat(s), f in Ln && ("autoAlpha" === f && (1 === u && "hidden" === sr(t, "visibility") && a && (u = 0), rr(this, C, "visibility", u ? "inherit" : "hidden", a ? "inherit" : "hidden", !a)), "scale" !== f && "transform" !== f && ~(f = Ln[f]).indexOf(",") && (f = f.split(",")[0])), g = f in Cn)
                    if (m || ((v = t._gsap).renderTransform && !e.parseTransform || vr(t, e.parseTransform), y = !1 !== e.smoothOrigin && v.smooth, (m = this._pt = new hn(this._pt, C, Un, 0, 1, v.renderTransform, v, 0, -1)).dep = 1), "scale" === f) this._pt = new hn(this._pt, v, "scaleY", v.scaleY, p ? p * a : a - v.scaleY), T.push("scaleY", f), f += "X";
                        ...
                        if ("transformOrigin" === f) {
                            w = void 0, x = void 0, k = void 0, w = (_ = s).split(" "), x = w[0], k = w[1] || "50%", "top" !== x && "bottom" !== x && "left" !== k && "right" !== k || (_ = x, x = k, k = _), w[0] = ur[x] || x, w[1] = ur[k] || k, s = w.join(" "), v.svg ? mr(t, s, 0, y, 0, this) : ((d = parseFloat(s.split(" ")[2]) || 0) !== v.zOrigin && rr(this, v, "zOrigin", v.zOrigin, d), rr(this, C, f, yr(o), yr(s)));
                            continue
                        }
                        if ("svgOrigin" === f) {
                            mr(t, s, 1, y, 0, this);
    ...
    mn.utils.checkPrefix = Gn, Sr = kt("x,y,z,scale,scaleX,scaleY,xPercent,yPercent," + (Cr = "rotation,rotationX,rotationY,skewX,skewY") + ",transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective", (function (t) {
        Cn[t] = 1
    })), kt(Cr, (function (t) {
        D.units[t] = "deg", hr[t] = 1
    })), Ln[Sr[13]] = "x,y,z,scale,scaleX,scaleY,xPercent,yPercent," + Cr, kt("0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY", (function (t) {
        var e = t.split(":");
        Ln[e[1]] = Sr[e[0]]
    })), kt("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective", (function (t) {
        D.units[t] = "px"
    })), mn.registerPlugin(Er), n.d(e, "a", (function () {
        return qr
    }));
        ...
        Ot = function (t, e) {
            if (!M || t) {
                ...
                for (n.forEach((function (t) {
                    ...
                    })), _ = vt.length; _--;) vt[_].scroll.rec = 0;
                l.pause(), Et("refresh")
    ...
    var $t = function () {
        ...
        return t.prototype.init = function (e, n) {
            if (this.progress = this.start = 0, this.vars && this.kill(1), N) {
                var i, c, l, f, h, m, b, w, x, k, S, P, L, j, I, B, U, G, K, ut, dt, mt, bt, xt, kt, Tt, Ct, Et, qt, Pt, At, Ot, Lt, jt, Mt, Nt, It, Wt, $t, Yt = (e = it($(e) || V(e) || e.nodeType ? {
                        trigger: e
                ...
                _e.media = q, oe *= 45, vt.push(_e), _e.scroller = he, _e.scroll = z(he, Yt), h = _e.scroll(), _e.vars = e, n = n || e.animation, "refreshPriority" in e && (T = 1), de.tweenScroll = de.tweenScroll || {
                    top: Ut(he, nt),
                    left: Ut(he, et)
                }, _e.tweenTo = i = de.tweenScroll[Yt.p], n && (n.vars.lazy = !1, n._initted || !1 !== n.vars.immediateRender && !1 !== e.immediateRender && n.render(0, !0, !0), _e.animation = n.pause(), n.scrollTrigger = _e, (Ot = V(te) && te) && (At = r.to(n, {
                    ease: "power3",
                    duration: Ot,
                    onComplete: function () {
                        return se && se(_e)
                    }
                })), qt = 0, Kt || (Kt = n.vars.id)), ce && (Q(ce) || (ce = {
                    snapTo: ce
                ...
                })).pause()), Kt && (yt[Kt] = _e), ee = _e.trigger = d(ee || ne)[0], ne = !0 === ne ? ee : d(ne)[0], $(Gt) && (Gt = {
                    targets: ee,
                    className: Gt
                }), ne && (!1 === re || "margin" === re || (re = !(!re && "flex" === rt(ne.parentNode).display) && Z), _e.pin = ne, !1 !== e.force3D && r.set(ne, {
                    force3D: !0
                }), (c = r.core.getCache(ne)).spacer ? I = c.pinState : (c.spacer = G = s.createElement("div"), G.setAttribute("class", "pin-spacer" + (Kt ? " pin-spacer-" + Kt : "")), c.pinState = I = Ht(ne)), _e.spacer = G = c.spacer, Et = rt(ne), xt = Et[re + Yt.os2], ut = r.getProperty(ne), dt = r.quickSetter(ne, Yt.a, tt), Rt(ne, G, Et), U = Ht(ne)), ye && (L = Q(ye) ? it(ye, ft) : ft, S = gt("scroller-start", Kt, he, Yt, L, 0), P = gt("scroller-end", Kt, he, Yt, L, 0, S), K = S["offset" + Yt.op.d2], x = gt("start", Kt, he, Yt, L, K), k = gt("end", Kt, he, Yt, L, K), ge || (($t = pe ? u : he).style.position = "absolute" === rt($t).position ? "absolute" : "relative", r.set([S, P], {
                    force3D: !0
                }), Tt = r.quickSetter(S, Yt.a, tt), Ct = r.quickSetter(P, Yt.a, tt))), _e.revert = function (t) {
                    ...
                    if (!v && _e.enabled)
                        if (ne && i && M) ct(t, "scrollEnd", St);
                            ...
                            if (b += q, w += q, _e._pinPush = A, x && q && ((o = {})[Yt.a] = "+=" + q, r.set([x, k], o)), ne) o = rt(ne), c = Yt === nt, a = _e.scroll(), mt = parseFloat(ut(Yt.a)) + A, !E && w > 1 && ((pe ? u : he).style["overflow-" + Yt.a] = "scroll"), Rt(ne, G, o), U = Ht(ne), s = ot(ne, !0), g = ge && z(he, c ? et : nt)(), re && ((kt = [re + Yt.os2, j + A + tt]).t = G, (R = re === Z ? st(ne, Yt) + j + A : 0) && kt.push(Yt.d, R + tt), Bt(kt), ge && _e.scroll(Nt)), ge && ((l = {
                                ...
                                return i.t = t.t, i
                            }(I, l, le)), n ? (y = n._initted, C(1), n.progress(1, !0), bt = ut(Yt.a) - mt + j + A, j !== bt && B.splice(B.length - 2, 2), n.progress(0, !0), y || n.invalidate(), C(0)) : bt = j;
                    ...
                    if (e && (m = h, h = l, ce && (Pt = qt, qt = n && !fe ? n.totalProgress() : p)), oe && !p && ne && !v && !A && M && b < l + (l - m) / (D() - g) * oe && (p = 1e-4), p !== y && _e.enabled) {
                        ...
                        ce && !i.tween && !v && !A && jt.restart(!0), Gt && (c || ue && p && (p < 1 || !E)) && d(Gt.targets).forEach((function (t) {
                            return t.classList[r || ue ? "add" : "remove"](Gt.className)
                        })), Qt && !fe && !t && Qt(_e), a && !v ? (o = p && !y ? 0 : 1 === p ? 1 : 1 === y ? 2 : 3, fe && (s = !c && "none" !== ve[o + 1] && ve[o + 1] || ve[o], n && ("complete" === s || "reset" === s || s in n) && ("complete" === s ? n.pause().totalProgress(1) : "reset" === s ? n.restart(!0).pause() : n[s]()), Qt && Qt(_e)), !c && E || (Jt && c && Jt(_e), me[o] && me[o](_e), ue && (1 === p ? _e.kill(!1, 1) : me[o] = 0), c || me[o = 1 === p ? 1 : 3] && me[o](_e))) : fe && Qt && !v && Qt(_e)
                    }
                    ...
                    var r = vt.indexOf(_e);
                    vt.splice(r, 1), r === _ && Dt > 0 && _--, n && (n.scrollTrigger = null, t && n.render(-1), e || n.kill()), x && [x, k, S, P].forEach((function (t) {
            ...
            if (!i && (r = e || B(), I() && window.document && (o = window, s = document, a = s.documentElement, u = s.body), r && (d = r.utils.toArray, p = r.utils.clamp, C = r.core.suppressOverwrites || R, r.core.globals("ScrollTrigger", t), u))) {
                ...
                }, ct(o, "mousewheel", _t), c = [o, s, a, u], ct(s, "scroll", _t);
                var n, h = u.style,
                    g = h.borderTop;
                h.borderTop = "1px solid #000", n = ot(u), nt.m = Math.round(n.top + nt.sc()) || 0, et.m = Math.round(n.left + et.sc()) || 0, g ? h.borderTop = g : h.removeProperty("border-top"), m = setInterval(bt, 200), r.delayedCall(.5, (function () {
                    return A = 0
                })), ct(s, "touchcancel", R), ct(u, "touchstart", R), ut(ct, s, "pointerdown,touchstart,mousedown", (function () {
                    return y = 1
                })), ut(ct, s, "pointerup,touchend,mouseup", (function () {
                    return y = 0
                })), b = r.utils.checkPrefix("transform"), Nt.push(b), i = D(), l = r.delayedCall(.2, Ot).pause(), k = [s, "visibilitychange", function () {
                    var t = o.innerWidth,
                        e = o.innerHeight;
            ...
            N = 0, vt.slice(0).forEach((function (t) {
                return t.kill(1)
            }))
        }, t.config = function (t) {
            ...
            var e, n, r, i, s;
            for (n in t) r = Tt.indexOf(n), i = t[n], q = n, "all" === n ? i() : (e = o.matchMedia(n)) && (e.matches && (s = i()), ~r ? (Tt[r + 1] = K(Tt[r + 1], i), Tt[r + 2] = K(Tt[r + 2], s)) : (r = Tt.length, Tt.push(n, i, s), e.addListener ? e.addListener(Ct) : e.addEventListener("change", Ct)), Tt[r + 3] = e.matches), q = 0;
            return Tt
    ...
    $t.version = "3.6.0", $t.saveStyles = function (t) {
        ...
        return t ? wt() : Ot(!0)
    }, $t.update = jt, $t.maxScroll = function (t, e) {
        return X(t, e ? et : nt)
    ...
    ! function (e, n) {
        ...
        var x =
            ...
            function (t) {
                ...
                for (e in n = at.support = {}, o = at.isXML = function (t) {
                        ...
                        if (h(t), n.matchesSelector && g && !E[e + " "] && (!v || !v.test(e)) && (!m || !m.test(e))) try {
                            var r = y.call(t, e);
        ...
        function ct(t, e) {
            for (var n, r, i = [], o = 0, s = t.length; o < s; o++)(r = t[o]).style && (n = r.style.display, e ? ("none" === n && (i[o] = V.get(r, "display") || null, i[o] || (r.style.display = "")), "" === r.style.display && ot(r) && (i[o] = ut(r))) : "none" !== n && (i[o] = "none", V.set(r, "display", n)));
            ...
            add: function (t, e, n, r, i) {
                ...
                if ($(t))
                    for (n.handler && (n = (o = n).handler, i = o.selector), i && _.find.matchesSelector(nt, i), n.guid || (n.guid = _.guid++), (u = m.events) || (u = m.events = Object.create(null)), (s = m.handle) || (s = m.handle = function (e) {
                        ...
                        }), c = (e = (e || "").match(j) || [""]).length; c--;) d = g = (a = xt.exec(e[c]) || [])[1], p = (a[2] || "").split(".").sort(), d && (f = _.event.special[d] || {}, d = (i ? f.delegateType : f.bindType) || d, f = _.event.special[d] || {}, l = _.extend({
                        type: d,
                        origType: g,
                        data: r,
                        handler: n,
        ...
        function Nt(t, e, n, r) {
            ...
            if (h && (s = (i = bt(e, t[0].ownerDocument, !1, t, r)).firstChild, 1 === i.childNodes.length && (i = s), s || r)) {
                ...
                if (u)
                    for (l = a[a.length - 1].ownerDocument, _.map(a, Dt), f = 0; f < u; f++) c = a[f], pt.test(c.type || "") && !V.access(c, "globalEval") && _.contains(l, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? _._evalUrl && !c.noModule && _._evalUrl(c.src, {
        ...
        _.extend({
            ...
            _.cssHooks[e] = {
                get: function (t, n, r) {
                    if (n) return !Vt.test(_.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? te(t, e, r) : Ht(t, Gt, (function () {
                        return te(t, e, r)
                    }))
                },
                set: function (t, n, r) {
                ...
                prefilters: [function (t, e, n) {
                    ...
                    for (r in n.queue || (null == (s = _._queueHooks(t, "fx")).unqueued && (s.unqueued = 0, a = s.empty.fire, s.empty.fire = function () {
                        ...
                        for (r in f && 1 === t.nodeType && (n.overflow = [p.overflow, p.overflowX, p.overflowY], null == (c = m && m.display) && (c = V.get(t, "display")), "none" === (l = _.css(t, "display")) && (c ? l = c : (ct([t], !0), c = t.style.display || c, l = _.css(t, "display"), ct([t]))), ("inline" === l || "inline-block" === l && null != c) && "none" === _.css(t, "float") && (u || (h.done((function () {
                            ...
                            }))), u = !1, d) u || (m ? "hidden" in m && (g = m.hidden) : m = V.access(t, "fxshow", {
                            display: c
                        }), o && (m.hidden = !g), g && ct([t], !0), h.done((function () {
                            for (r in g || ct([t]), V.remove(t, "fxshow"), d) _.style(t, r, d[r])
                        }))), u = ce(g ? m[r] : 0, r, h), r in m || (m[r] = u.start, g && (u.end = u.start, u.start = 0))
                }],
        ...
        _.ajaxSetup({
            ...
            var i, o, s, a = !1 !== e.jsonp && ($e.test(e.url) ? "url" : "string" == typeof e.data && 0 === (e.contentType || "").indexOf("application/x-www-form-urlencoded") && $e.test(e.data) && "data");
            if (a || "jsonp" === e.dataTypes[0]) return i = e.jsonpCallback = p(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace($e, "$1" + i) : !1 !== e.jsonp && (e.url += (ke.test(e.url) ? "&" : "?") + e.jsonp + "=" + i), e.converters["script json"] = function () {
        ...
        })), d.createHTMLDocument = ((Xe = m.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === Xe.childNodes.length), _.parseHTML = function (t, e, n) {
        ...
        _.proxy = function (t, e) {
            var n, r, o;
            if ("string" == typeof e && (n = t[e], e = t, t = n), p(t)) return r = i.call(arguments, 2), (o = function () {
                return t.apply(e || this, r.concat(i.call(arguments)))
            }).guid = t.guid = t.guid || _.guid++, o
        }, _.holdReady = function (t) {
            t ? _.readyWait++ : _.ready(!0)
        }, _.isArray = Array.isArray, _.parseJSON = JSON.parse, _.nodeName = S, _.isFunction = p, _.isWindow = g, _.camelCase = U, _.type = b, _.now = Date.now, _.isNumeric = function (t) {
            var e = _.type(t);
        ...
        var s = new(function () {
            ...
            return n = e, (s = [{
                ...
                value: function (e) {
                    ...
                    }), i.a.refresh(), this.changeBar(), this.vw = window.innerWidth, this.vw < 1025 && (this.vw, window.innerHeight), this.rem = this.vw / 1440 * 10 * 5.6, this.fgt_btn = t("button.create-forg__forgot") || null, this.fgt_btn.length > 0 && this.showForgot()
                }
            }, {
                key: "isTop",
                value: function () {
                ...
                value: function () {
                    var t = this,
                        e = window.innerWidth,
                        n = e / 1440 * 10 * 5.6;
                    e < 1025 && window.innerHeight, this.prod_descr = this.qsa(".trg-blue"), this.prod_descr.forEach((function (e) {
                        i.a.create({
                            trigger: e,
                ...
                value: function () {
                    var t = this,
                        e = window.innerWidth,
                        n = e / 1440 * 10 * 5.6;
                    e < 1025 && window.innerHeight, i.a.create({
                ...
                key: "parallaxHeader",
                value: function () {
                    this.parallax_header = this.qs(".el-plx-header"), t(".page-about").length > 0 && window.innerWidth < 1025 && (this.parallax_header = this.qs(".header-about__video.no-desk .el-plx-header")), r.a.to(this.parallax_header, {
                        scrollTrigger: {
                            trigger: "body",
                            start: "top 0%",
                ...
                value: function () {
                    var e = 40;
                    window.innerWidth > 1024 && (e = 50), this.parallax_header = this.qs(".section-imgplx__img.el-plx"), t(this.parallax_header).length > 0 && r.a.to(this.parallax_header.querySelector("img"), {
                        scrollTrigger: {
                        ...
                        yPercent: e,
                        ease: "none"
                    }), this.parallax_aboutsec = this.qs(".section-plxabout__img.el-plx"), t(this.parallax_aboutsec).length > 0 && r.a.to(this.parallax_aboutsec.querySelector("img"), {
                        scrollTrigger: {
                ...
                value: function () {
                    var t = 40;
                    window.innerWidth > 1024 && (t = 50), this.newsl = this.qs("#shopify-section-section-newsl .section-newsl"), r.a.to(this.newsl.querySelector("img"), {
                        scrollTrigger: {
                            trigger: this.newsl,
                            start: "top 100%",
                            end: "bottom top",
            ...
            return n = e, (o = [{
                ...
                value: function () {
                    ...
                    this.qsa = function (e) {
                        ...
                        var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : t;
                        return n.querySelector(e)
                    }, this.body = this.qs("body"), this.cart_counter = this.qsa(".cart-counter "), this.firstload = !1, this.cart = {
                ...
                value: function () {
                    ...
                    fetch("https://solace-store.com//cart").then((function (t) {
                        ...
                        e.cart.receiver.appendChild(i), e.verifyNew(), e.onClick(i), t(e.cart_counter).text(t(i).data("cartcounter")), r.a.removeItem(i), r.a.onQtyChange(i), setTimeout((function () {
                ...
                value: function (e) {
                    ...
                    })), this.cart.close = e.querySelectorAll(".cart__close, .browse, .cart .item-title, .empty-bag a"), t(this.cart.close).add(this.cart.fader_close).click((function () {
    ...
    t.exports = function () {
        ...
        h.match = function (t, e) {
            ...
            return _(y(t, e), e)
        }, h.tokensToFunction = g, h.tokensToRegExp = m;
        var S = {
                container: "container",
                history: "history",
                namespace: "namespace",
                ...
                try {
                    var n = function () {
                        if (!e.next.html) return Promise.resolve(t).then((function (t) {
                            ...
                            if (t) {
                                var r = E.toElement(t);
                                n.namespace = E.getNamespace(r), n.container = E.getContainer(r), n.html = t, q.update({
                                    ns: n.namespace
                                });
        ...
        var F = new(function (t) {
            ...
            tt = function (t) {
                ...
                var n = e.prototype;
                return n.init = function () {
                    this.add("pushState", X), this.add("exists", U), this.add("newTab", $), this.add("blank", Y), this.add("corsDomain", V), this.add("corsPort", Q), this.add("download", G), this.add("preventSelf", K), this.add("preventAll", J), this.add("sameUrl", Z, !1)
        ...
        return new(function () {
            function t() {
                this.version = "2.9.7", this.schemaPage = ot, this.Logger = f, this.logger = new f("@barba/core"), this.plugins = [], this.hooks = F, this.dom = E, this.helpers = O, this.history = q, this.request = I, this.url = R
            }
            var r = t.prototype;
            return r.use = function (t, e) {
                ...
                if (f.setLevel(!0 === (void 0 !== w && w) ? "debug" : void 0 === x ? "off" : x), this.logger.info(this.version), Object.keys(u).forEach((function (t) {
                        S[t] && (S[t] = u[t])
                    })), this.$ = c, this.timeout = h, this.cacheIgnore = p, this.prefetchIgnore = m, this.preventRunning = y, this._ = this.dom.getWrapper(), !this._) throw new Error("[@barba/core] No Barba wrapper found");
    ...
    (function (t) {
        ...
        var o = new(function () {
            ...
            return n = e, (o = [{
                ...
                value: function () {
                    var e = this;
                    this.each_liimg = document.querySelectorAll("li.intro__img"), this.each_img = document.querySelectorAll("li.intro__img img"), this.time = 1.8, this.tl_intoimgs = r.a.timeline({
                        defaults: {
                            duration: this.time,
                            ease: "expo.out"
                        }
                    }), this.animateHeader(), this.animateImgs(), this.animateLoader(), this.tl_master = r.a.timeline({
                        paused: !0
                    }).to(this.counter, {
                        delay: .5,
                        duration: .6,
                ...
                value: function () {
                    ...
                    }, window.innerWidth < 1025 && (this.header.texts = document.querySelectorAll(".header-index__text.no-desk h1 span")), this.tl_header = r.a.timeline({
                        defaults: {
                            ease: "expo.out"
                        }
                ...
                key: "animateLoader",
                value: function () {
                    this.counter = document.querySelector(".intro__logos"), this.counter_loader = document.querySelector("span.load-counter"), this.percentLoader = {
                        n: 0
                    }
                }
            }, {
                ...
                value: function () {
                    ...
                    this.tl_intoimgs.add("tog0"), this.tl_intoimgs.fromTo(n, {
                        n: 100
                    }, {
                        n: 0,
                        onUpdate: function () {
                    ...
                    }, "tog0"), this.tl_intoimgs.fromTo(t(this.each_img).eq(0), {
                        scale: 1.8
                    }, {
                        scale: 1
                    }, "tog0").add("tog1"), this.tl_intoimgs.fromTo(i, {
                        n: 100
                    }, {
                        n: 0,
                        onUpdate: function () {
                    ...
                    }, "tog1-=".concat(.85 * this.time)), this.tl_intoimgs.fromTo(t(this.each_img).eq(1), {
                        scale: 1.8
                    }, {
                        scale: 1
                    }, "tog1-=".concat(.85 * this.time)).add("tog2"), this.tl_intoimgs.fromTo(o, {
                        n: 100
                    }, {
                        n: 0,
                        onUpdate: function () {
                    ...
                    }, "tog2-=".concat(.85 * this.time)), this.tl_intoimgs.fromTo(t(this.each_img).eq(2), {
                        scale: 1.8
                    }, {
                        scale: 1
                    }, "tog2-=".concat(.85 * this.time)).add("tog3"), this.tl_intoimgs.fromTo(s, {
                        n: 100
                    }, {
                        n: 0,
                        onUpdate: function () {
                    ...
                    }, "tog3-=".concat(.85 * this.time)), this.tl_intoimgs.fromTo(t(this.each_img).eq(3), {
                        scale: 1.8
                    }, {
                        scale: 1
                    }, "tog3-=".concat(.85 * this.time)).add("tog4"), this.tl_intoimgs.fromTo(a, {
                        n: 100
                    }, {
                        n: 0,
                        onUpdate: function () {
                    ...
                    }, "tog4-=".concat(.85 * this.time)), this.tl_intoimgs.fromTo(t(this.each_img).eq(4), {
                        scale: 1.8
                    }, {
                        scale: 1
                    }, "tog4-=".concat(.85 * this.time)).add("tog5"), this.tl_intoimgs.fromTo(u, {
                        n: 100
                    }, {
                        n: 0,
                        onUpdate: function () {
                    ...
                    }, "tog5-=".concat(.85 * this.time)), this.tl_intoimgs.fromTo(t(this.each_img).eq(5), {
                        scale: 1.8
                    }, {
                        scale: 1
                    }, "tog5-=".concat(.85 * this.time)).add("tog6"), this.tl_intoimgs.fromTo(c, {
                        n: 100
                    }, {
                        n: 0,
                        onUpdate: function () {
                    ...
                    }, "tog6-=".concat(.85 * this.time)), this.tl_intoimgs.fromTo(t(this.each_img).eq(6), {
                        scale: 1.8
                    }, {
                        scale: 1
                    }, "tog6-=".concat(.85 * this.time)).add("tog7"), this.tl_intoimgs.fromTo(t(".intro__hold"), {
                        yPercent: 0
                    }, {
                        duration: 1.2 * this.time,
                        yPercent: -50,
                        ease: "expo.inOut"
                    }, "tog7-=".concat(.5 * this.time)), this.tl_intoimgs.fromTo(t(".intro__fader"), {
                        opacity: 0
                    }, {
                        duration: 1.2 * this.time,
                        opacity: 1,
                        ease: "expo.inOut"
                    }, "tog7-=".concat(.5 * this.time)), this.tl_intoimgs.fromTo(this.header.video_ctn, {
                        yPercent: 100
                    }, {
                        duration: 1.2 * this.time,
                        yPercent: 0,
                        ease: "expo.inOut"
                    }, "tog7-=".concat(.5 * this.time)), this.tl_intoimgs.fromTo(this.header.video, {
                        yPercent: -80
                    }, {
                        duration: 1.2 * this.time,
                        yPercent: 0,
        ...
        var f = new(function () {
            ...
            return n = e, (f = [{
                ...
                value: function (e, n, r) {
                    this.contentPage = document.querySelector("[data-scroll-content]"), this.isPage = t(this.contentPage).data("ispage"), this.once = !1, this.onceGlobal = !1, this.math = {
                        lerp: function (t, e, n) {
                            return (1 - n) * t + n * e
                        },
                        norm: function (t, e, n) {
        ...
        return e = t, (n = [{
            ...
            value: function (t) {
                ...
                this.qsa = function (t) {
                    ...
                    scroller: "[data-scroll-content]"
                }), i.a.refresh(), this.vw < 1025 && (this.vw, window.innerHeight), this.rem = this.vw / 1440 * 10 * 5.6, window.innerWidth > 1024 && (this.stickyList(), this.parallaxListAbout()), this.changeBarBlue()
            }
        }, {
            key: "stickyList",
            value: function () {
                var t = window.innerWidth,
                    e = t / 1440 * 10 * 5.6;
                t < 1025 && window.innerHeight, this.list_about = this.qs(".section-listabout"), this.list_holder = this.qs(".section-listabout__hold"), this.list_release = this.qs(".release-list"), i.a.create({
            ...
            value: function () {
                var t = this,
                    e = window.innerWidth;
                e < 1025 && window.innerHeight, this.list_about = this.qs(".section-listabout"), this.list_holder = this.qs(".section-listabout__hold"), this.list_release = this.qs(".release-list"), this.list_title = this.qs("h1.section-listabout__title"), r.a.from(this.list_title, {
                    scrollTrigger: {
                        trigger: this.list_about,
                        start: "top 100%",
                        scrub: !0,
                ...
                }), this.list_items = this.qsa(".section-listabout__content ul.items__each"), this.list_items.forEach((function (e, n) {
                    t.tl_items.fromTo(e, {
                        "--lineWidth": "0%"
                    }, {
                        duration: 1,
                        "--lineWidth": "100%",
                        ease: "power0.out"
                    }, "tog".concat(n)), t.tl_items.from(e.querySelectorAll("li"), {
                        duration: .7,
                        opacity: 0,
                        ease: "power0.out"
                    }, "tog".concat(n)), t.tl_items.from(e.querySelectorAll("li"), {
            ...
            value: function () {
                var t = this,
                    e = window.innerWidth,
                    n = e / 1440 * 10 * 5.6;
                e < 1025 && window.innerHeight, this.prod_descr = this.qsa(".trg-blue-list"), this.prod_descr.forEach((function (e) {
                    i.a.create({
                        trigger: e,
                        start: "top 0%+=".concat(n, "px"),
            ...
            return n = e, (i = [{
                ...
                value: function () {
                    ...
                    this.qsa = function (t) {
                        ...
                        scroller: "[data-scroll-content]"
                    }), o.a.refresh(), this.anchorsImgs(), this.pinObjects()), this.verifyVariantPage(), this.onClick()
                }
            }, {
                key: "onClick",
                value: function () {
                    this.trg_descr = this.qs(".trg-descr"), this.trg_ship = this.qsa(".trg-ship"), this.trg_close = this.qs(".header-prod__infos__modal__close"), t(this.trg_descr).click((function () {
                        t("body").addClass("is-modal-prod"), r.a.delayedCall(.3, (function () {
                ...
                value: function () {
                    var e = this;
                    this.prod_descr_hold = this.qs(".header-prod__infos__hold"), o.a.create({
                        ...
                        toggleClass: "floating"
                    }), this.prod_thumbs = this.qsa(".header-prod__thumbs__travel"), o.a.create({
                        trigger: ".header-prod__infos",
                        start: "top 8.5%",
            ...
            return n = e, (r = [{
                ...
                value: function () {
                    ...
                    this.qsa = function (t) {
                        ...
                        scroller: "[data-scroll-content]"
                    }), s.a.refresh(), this.stickyFilter()), this.sortBy(), this.onClick()
                }
            }, {
                key: "onClick",
                value: function () {
                    ...
                    }.bind(this), null), this.qs(".collect-filter__sortby").addEventListener("click", function () {
                ...
                key: "stickyFilter",
                value: function () {
                    this.filter_prod = this.qs(".collect-filter__pin"), s.a.create({
    ...
    (function (t) {
        ...
        var s = new(function () {
            function e() {
                ...
                }, this.body = document.querySelector("body"), this.animating = !1
            }
            var n, s, a;
            return n = e, (s = [{
                key: "init",
                ...
                value: function (e) {
                    ...
                    console.log(t(e)[0]), t(this.modallb.img).attr("src", i.img), t(this.modallb.descr).text(i.descr), t(this.modallb.title).text(i.title), this.modallb.links.forEach((function (e) {
                        t(e).attr("href", i.url)
                    ...
                    r.a.fromTo(this.modallb.fader, {
                        ...
                        onComplete: function () {
                            r.a.set(t.modallb.el, {
                                autoAlpha: 0
                            }), t.animating = !1, t.body.classList.remove("is-modallb")
                        }
                    })
                }
            }, {
                ...
                value: function () {
                    var e = this;
                    this.each_item = this.qsa(".lb__item"), t(this.each_item).click((function () {
                ...
                key: "stickyLBDecor",
                value: function () {
                    this.lb_decor = this.qs(".lb__decor"), i.a.create({
                        trigger: "body",
                        start: "top top",
                        pin: this.lb_decor,
    ...
    (function (t) {
        ...
        var o = new(function () {
            ...
            return n = e, (o = [{
                ...
                value: function () {
                    var e = document;
                    this.body = document.querySelector("body"), this.qsa = function (t) {
                        var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : e;
                        return n.querySelectorAll(t)
                    }, this.qs = function (t) {
                        var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : e;
                        return n.querySelector(t)
                    }, this.my_storage = localStorage.getItem("cookieBar", null), this.cookies = {
                        el: this.qs(".cookies"),
                        close: this.qs(".cookies__close")
                    }, r.a.set(document.querySelector(".modal-lb"), {
                        autoAlpha: 0
                    }), this.onClick(), this.verifyStorage(), t(".top-bar").length > 0 && this.topBar()
                }
            }, {
                key: "onClick",
                value: function () {
                ...
                value: function () {
                    ...
                    var n = Math.max(document.documentElement.clientWidth, 320),
                        r = .01 * n;
                    document.documentElement.style.setProperty("--vw", "".concat(r, "px")), t(window).resize((function () {
                        e = .01 * window.innerHeight, r = .01 * n, document.documentElement.style.setProperty("--vh", "".concat(e, "px")), n = Math.max(document.documentElement.clientWidth, 320), document.documentElement.style.setProperty("--vw", "".concat(r, "px"))
                    }))
                }
            }, {
                key: "topBar",
                value: function () {
                    ...
                    }, t(this.body).addClass("is-topbar"), t(this.topbar.close).click((function () {
        ...
        var h = function () {
            ...
            return n = e, (r = [{
                    ...
                    this.swipe = {
                        ...
                        transitions: [{
                            ...
                            leave: function (t) {
                                ...
                                a.a.set("body", {
                                    overflow: "hidden"
                                }), u.a.destroy(), t.trigger, a.a.set(e.swipe.el, {
                                    autoAlpha: 1
                            ...
                            once: function (n) {
                                var r = n.next;
                                e.callingFunctions(r), t("body").hasClass("search") && a.a.delayedCall(2, (function () {
                                    window.dispatchEvent(new Event("resize"))
                                }))
                            }
                        }]
                ...
                value: function (t) {
                    ...
                    e("js", new Date), e("config", "G-PZFZPMVMXD", {
                        anonymize_ip: !0,
                ...
                value: function () {
                    for (var t = document.querySelectorAll("a[href]"), e = function (t) {
                        ...
                        }, n = 0; n < t.length; n++) t[n].addEventListener("click", e)
                }
    ...
    var o = new(function () {
        ...
        return e = t, (n = [{
            ...
            value: function () {
                var t = this;
                this.imgs_lb = this.qsa(".section-proposal__img img.e-abs"), r.a.set(this.imgs_lb, {
                    opacity: 0
        ...
        b = {
            ...
            init: function (t, e, n, r, s) {
                ...
                this.isWin = t === o, this.target = t, this.tween = n, e = function (t, e, n, r) {
                    if (d(t) && (t = t(e, n, r)), "object" != typeof t) return h(t) && "max" !== t && "=" !== t.charAt(1) ? {
                        x: t,
                        y: t
                    } : {
                        y: t
                    ...
                    return o
                }(e, r, t, s), this.vars = e, this.autoKill = !!e.autoKill, this.getX = g(t, "x"), this.getY = g(t, "y"), this.x = this.xPrev = this.getX(), this.y = this.yPrev = this.getY(), null != e.x ? (this.add(this, "x", this.x, v(e.x, t, "x", this.x, e.offsetX || 0), r, s, Math.round), this._props.push("scrollTo_x")) : this.skipX = 1, null != e.y ? (this.add(this, "y", this.y, v(e.y, t, "y", this.y, e.offsetY || 0), r, s, Math.round), this._props.push("scrollTo_y")) : this.skipY = 1
            },
            render: function (t, e) {
        ...
        var o = new(function () {
            ...
            return n = e, (o = [{
                ...
                value: function () {
                    ...
                    }, this.travel_size = t(".header-prod__gallery__each").eq(1).outerWidth(!0), this.options = {
                        time: .75,
                        animating: !1,
                        prev: -1,
                        current: 0,
                        length: t(".header-prod__gallery__each").length
                    }, t(this.swipe.next).text("/" + this.options.length), this.getSizeSwipe(), this.onClickSwipe();
                    var e = this;
                ...
                key: "getSizeSwipe",
                value: function () {
                    this.travel_size = t(".header-prod__gallery__each").eq(1).outerWidth(!0), this.options.current = 0, r.a.set(this.swipe.travel, {
                        x: 0
                    })
                }
            }, {
                ...
                value: function () {
                    ...
                    }), !1), this.swipe.el.addEventListener("touchmove", (function (i) {
                        if (e && n) {
            ...
            return n = e, (o = [{
                ...
                value: function () {
                    ...
                    this.qsa = function (e) {
                        ...
                        var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : t;
                        return n.querySelector(e)
                    }, this.body = this.qs("body"), this.menu = {
                    ...
                    }, this.animating = !1, this.setters(), this.onClick()
                }
            }, {
                key: "setters",
                value: function () {
                ...
                value: function (e, n) {
                    ...
                    n.addClass("trg-dd-active"), e.addClass("dd-active"), t(this.body).addClass("is-dropd"), r.a.set(e, {
                        opacity: 1
                    }), r.a.to(o, {
                        duration: 1,
                        y: 0,
                ...
                value: function (t, e) {
                    ...
                    t.find(".menu-dd__links"), t.find(".menu-dd__featured"), t.removeClass("dd-active"), e.removeClass("trg-dd-active"), r.a.to(t, {
                        duration: .8,
                        opacity: .75,
                        ease: "none",
                        overwrite: "true"
                ...
                value: function () {
                    ...
                    t(this.menu.trg).click((function () {
                        var n = this;
                        if (!e.animating) {
                            e.animating = !0, r.a.set(e.menu.els, {
                                autoAlpha: 1
                            });
                            var i = t(e.menu.trg).index(this);
                            t(e.body).hasClass("is-top") && t(e.body).removeClass("is-top"), t(e.body).hasClass("is-minicart") && t(".cart__close").trigger("click"), t(this).hasClass("trg-dd-active") ? (e.desactiveDD(t(e.menu.els).eq(i), t(this)), t(e.body).removeClass("is-dropd"), r.a.to(e.menu.fader, {
                                delay: .5,
                                duration: .6,
                                autoAlpha: 0,
                                ease: "none",
    ...
    r.a.config({
        nullTargetWarn: !1
    }), new i.a, o.a.init(), s.a.init(), o.a.fixMobile(), a.a.init(), u.a.init(), (0, n(25).consoleTag)()
}, function (t, e, n) {
    /*!
     * imagesLoaded v4.1.4
    ...
    t.exports = {
        consoleTag: function () {
            ...
            } else window.console && window.console.log("Made with love ❤️ Victor Work - https://victor.work/  ❤️");
            return 0
        }
    }
}, function (t, e) {}]);